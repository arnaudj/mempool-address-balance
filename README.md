...
The data source is the mempool.js [confirmed transactions history](https://github.com/mempool/mempool.js/blob/HEAD/README-bitcoin.md#get-address-txs-chain) for that address.
...
_A wallet balance is actually the sum of the UTXOs controlled by the wallet's private keys._

_UTXO stands for Unspent Transaction (TX) Output. Every on-chain transaction sends BTC to one or more addresses, from at least zero (in case of a coinbase transcation) addresses._
